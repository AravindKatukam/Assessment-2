...
async function start(){
    ...
    await page.goto("https://www.switusa.com/swit-monitors",{waitUntil:'networkidle0'})

    //To get category, started with moniter page and used xpath to navigate to product page and used xpath to click on the dropdown
    await page.click("._3g4hn._33aXP._1bfeM > li:nth-of-type(1) > div > ._3mKI1")
    ...
    fs.writeFile("data.json", JSON.stringify(grabData,null,2), (err)=>{
        if (err) {
            console.error(err)
            return
        }
